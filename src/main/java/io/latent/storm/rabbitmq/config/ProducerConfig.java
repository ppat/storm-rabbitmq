...
public class ProducerConfig implements Serializable {
  ...
  public static ProducerConfig getFromStormConfig(Map<String, Object> stormConfig) {
    ...
    return new ProducerConfig(connectionConfig, getFromMap("rabbitmq.exchangeName", stormConfig), getFromMap("rabbitmq.contentType", stormConfig), getFromMap(
        "rabbitmq.contentEncoding", stormConfig), getFromMapAsBoolean("rabbitmq.persistent", stormConfig));
  }
